...
$(function () {
    ...
    n.length &&
        ((t = n.DataTable({
            ...
            columns: [{ data: "id" }, { data: "order" }, { data: "image" }, { data: "customer" }, { data: "date" }, { data: "total" }, { data: "" }],
            columnDefs: [
                {
                    className: "control",
                    searchable: !1,
                ...
                },
                {
                    targets: 1,
                    render: function (t, e, a, s) {
                        return '<a href="/Admin/OrderDetails/' + a.id + '"><span>#' + a.id + "</span></a>";
                    },
                },
                {
                    targets: 2,
                ...
                },
                {
                    ...
                    render: function (t, e, a, s) {
                        var n = a.customer
                            , r = a.email
                            , o = a.avatar;
                        return '<div class="d-flex justify-content-start align-items-center order-name text-nowrap"><div class="avatar-wrapper"><div class="avatar avatar-sm me-3">' + (o ? '<img src="' + o + '" alt="Avatar" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (o = (((o = (n = a.customer).match(/\b\w/g) || []).shift() || "") + (o.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><h6 class="m-0"><a href="/User/Details/' + a.userid + '" class="text-heading">' + n + "</a></h6><small>" + r + "</small></div></div>"
                    }
                },
                {
                    targets: 4,
                ...
                },
                {
                    ...
                    orderable: !1,
                    render: function (t, e, a, s) {
                        return '<div class="d-flex justify-content-sm-start align-items-sm-center"><button class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical"></i></button><div class="dropdown-menu dropdown-menu-end m-0"><a href="/Admin/OrderDetails/' + a.id + '" class="dropdown-item">View</a><a href="javascript:0;" class="dropdown-item delete-record">Delete</a></div></div>';
                    },
                },
            ],
            order: [3, "asc"],
